...
import 'package:invest_naija/business_logic/providers/proof_of_id_document_provider.dart';
...
class ProofOfIdScreen extends StatefulWidget {
  const ProofOfIdScreen({Key key}) : super(key: key);

  @override
  _ProofOfIdScreenState createState() => _ProofOfIdScreenState();
}

class _ProofOfIdScreenState extends State<ProofOfIdScreen> with DialogMixins{
    ...
    return Container(
      child: Column(
        children: [
          ...
          const SizedBox(height: 40,),
          Consumer<ProofOfIdDocumentProvider>(
            ...
            builder: (context, documentProvider, widget) {
              return Container(
                child: AnimatedSwitcher(
                  ...
                  child: documentProvider.profOfIdImage.isEmpty? Offstage( offstage: true,) :
                  _imageUploaded(
                      documentType: documentProvider.profOfIdDocumentType,
                      imageUrl: documentProvider.profOfIdImage
                  ),
                ),
              );
            },
          ...
          Consumer<ProofOfIdDocumentProvider>(
              builder: (context, documentProvider, widget) {
                return CustomButton(
                  data: "Save Document",
                  isLoading: documentProvider.isUploadingProofOfId,
                  color: Constants.primaryColor,
                  textColor: Constants.whiteColor,
                  onPressed: documentProvider.isUploadingProofOfId
                      ? null
                      : () async {
